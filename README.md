...
# [Yambo](http://www.yambo-code.org/) installation 
Installation on [Stokes Supercluster of UCF](https://arcc.ist.ucf.edu)   
...
```
The detailed description of these parameters is [here](https://www.yambo-code.eu/wiki/index.php?title=GW_parallel_strategies) By default *SE_Threads*, *DIP_Threads*, and *X_Threads* are set to zero and controlled by the OMP_NUM_THREADS environment variable.
